public class customvisitor extends visitor<Object> {
        ...
        @Override
        public Object visitExpresion(MiCompiladorParser.ExpresionContext ctx) {
            System.out.println("Visit: expresion -> Evalúa expresión relacional");
            return visitChildren(ctx);
        }
    
        @Override
        public Object visitExpresion_simple(MiCompiladorParser.Expresion_simpleContext ctx) {
            System.out.println("Visit: expresion_simple -> Evalúa suma/resta");
            return visitChildren(ctx);
        }
    
        @Override
        public Object visitTermino(MiCompiladorParser.TerminoContext ctx) {
            System.out.println("Visit: termino -> Evalúa multiplicación/división");
            return visitChildren(ctx);
        }
    
        @Override
        public Object visitFactor(MiCompiladorParser.FactorContext ctx) {
            System.out.println("Visit: factor -> Devuelve valor o variable");
            return visitChildren(ctx);
        }
